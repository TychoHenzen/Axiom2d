...
Widget _wrap(CustomPainter painter) => Directionality(
  ...
  child: CustomPaint(size: const Size(20, 200), painter: painter),
);

void main() {
  testWidgets(
    'when_tube_renders_then_custom_painter_creates_translucent_walls',
    (tester) async {
      // Arrange
  ...
  testWidgets(
    'when_tube_has_settled_grains_then_interior_shows_colored_pixels',
    (tester) async {
      // Arrange
