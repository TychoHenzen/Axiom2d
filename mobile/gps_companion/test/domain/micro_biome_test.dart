...
void main() {
  ...
  group('microBiomeAt radius behaviour', () {
    test(
      'when_query_at_poi_center_then_returns_non_null_with_full_density',
      () {
        // Act
        ...
        expect(
          result!.densityPerKm2,
          MicroBiomeCategory.waterFeature.densityBump,
    ...
    test('when_moving_away_from_poi_then_density_decreases_monotonically', () {
      ...
      for (var metres = 0.0; metres < category.radiusM; metres += 1.0) {
        ...
        expect(
          result,
          isNotNull,
          reason: 'should be within radius at $metres m',
        );
      ...
      for (var i = 0; i < densities.length - 1; i++) {
        expect(
          densities[i],
          greaterThanOrEqualTo(densities[i + 1]),
          reason:
