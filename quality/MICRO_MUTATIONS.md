...
**Cumulative (all runs)**: 1970 mutants | 462 caught | 1422 missed | 8 timeout | 78 unviable | 23 zero-mutant | 1 errors | **catch rate: 24.5%** | 76 runs | 75 files tested

**Last run**: 2026-08-04 (`8b4f8e7`)
...
| 59% | `crates/particle_poc/src/state.rs` | 2246 | 9 | 19d | 2026-07-16 | 0/1238 (0%) | ⚠️ |
...
| 40% | `crates/card_game/src/stash/store.rs` | 555 | 5 | 10d | 2026-07-25 | error | ❌ |
| 38% | `crates/card_game/src/card/screen_device.rs` | 389 | 4 | 12d | 2026-07-23 | 24/86 (28%) | ⚠️ |
| 36% | `crates/engine_render/src/testing/mod.rs` | 385 | 0 | 23d | 2026-07-12 | 28/59 (47%) | ⚠️ |
| 35% | `crates/axiom2d/src/splash/letters.rs` | 270 | 1 | 20d | 2026-07-15 | 0 mutants | ➖ |
| 33% | `crates/axiom2d/src/default_plugins.rs` | 203 | 1 | 19d | 2026-07-16 | 5/6 (83%) | ⚠️ |
| 32% | `crates/card_game/src/card/identity/card_name.rs` | 113 | 0 | 25d | 2026-07-10 | 0 mutants | ✅ |
| 31% | `crates/card_game/src/booster/device.rs` | 377 | 2 | 7d | 2026-07-28 | 7/49 (14%) | ⚠️ |
| 31% | `crates/engine_core/src/time.rs` | 123 | 0 | 22d | 2026-07-13 | 13/20 (65%) | ✅ |
| 31% | `crates/engine_scene/src/transform_propagation.rs` | 74 | 0 | 25d | 2026-07-10 | 0 mutants | ✅ |
| 31% | `crates/card_game/src/card/rendering/debug_spawn.rs` | 79 | 0 | 24d | 2026-07-11 | 3/3 (100%) | ✅ |
| 30% | `crates/engine_render/src/shader.rs` | 66 | 0 | 24d | 2026-07-11 | 19/22 (86%) | ✅ |
| 30% | `crates/engine_render/src/atlas.rs` | 163 | 2 | 10d | 2026-07-25 | 57/60 (95%) | ✅ |
| 29% | `crates/card_game/src/card/reader/spawn.rs` | 229 | 0 | 14d | 2026-07-21 | 0/32 (0%) | ⚠️ |
| 29% | `crates/terrain/src/material.rs` | 130 | 0 | 18d | 2026-07-17 | 2/5 (40%) | ⚠️ |
| 29% | `crates/axiom2d/src/splash/mod.rs` | 15 | 3 | 22d | 2026-07-13 | 0 mutants | ➖ |
| 28% | `crates/card_game/src/plugin.rs` | 203 | 0 | 13d | 2026-07-22 | 2/2 (100%) | ✅ |
| 27% | `crates/card_game/src/hand/cards.rs` | 52 | 1 | 17d | 2026-07-18 | 13/16 (81%) | ⚠️ |
| 27% | `crates/engine_ui/src/draw_command.rs` | 84 | 0 | 17d | 2026-07-18 | 2/7 (29%) | ⚠️ |
| 26% | `crates/engine_render/src/bloom.rs` | 43 | 0 | 21d | 2026-07-14 | 22/22 (100%) | ✅ |
| 26% | `crates/card_game/src/card/identity/name_pools/templates.rs` | 87 | 0 | 15d | 2026-07-20 | 18/29 (62%) | ⚠️ |
| 26% | `crates/engine_input/src/mouse_button.rs` | 22 | 0 | 24d | 2026-07-11 | 0/1 (0%) | ⚠️ |
| 25% | `crates/engine_core/benches/spring.rs` | 97 | 0 | 13d | 2026-07-22 | 0 mutants | ➖ |
| 25% | `crates/engine_physics/benches/stress.rs` | 45 | 0 | 18d | 2026-07-17 | 0 mutants | ➖ |
| 24% | `crates/card_game/src/card/reader/drag.rs` | 67 | 0 | 14d | 2026-07-21 | 5/9 (56%) | ⚠️ |
| 24% | `crates/card_game/src/card/identity/signature/types.rs` | 204 | 0 | 6d | 2026-07-29 | 39/46 (85%) | ✅ |
| 24% | `crates/engine_audio/src/mixer.rs` | 44 | 0 | 16d | 2026-07-19 | 6/6 (100%) | ✅ |
| 24% | `crates/card_game/src/card/identity/name_pools/syllables.rs` | 33 | 0 | 18d | 2026-07-17 | 2/2 (100%) | ✅ |
| 23% | `crates/card_game/src/card/reader.rs` | 22 | 0 | 19d | 2026-07-16 | 0 mutants | ➖ |
| 23% | `crates/card_game/src/card/art_selection.rs` | 119 | 0 | 7d | 2026-07-28 | 45/63 (71%) | ⚠️ |
| 22% | `crates/engine_render/src/shape/components.rs` | 125 | 0 | 6d | 2026-07-29 | 5/10 (50%) | ⚠️ |
| 22% | `crates/card_game/src/card/art/mod.rs` | 49 | 0 | 12d | 2026-07-23 | 17/18 (94%) | ⚠️ |
| 22% | `crates/card_game/src/card/interaction/flip_animation.rs` | 47 | 0 | 12d | 2026-07-23 | 21/23 (91%) | ⚠️ |
| 21% | `crates/engine_input/src/keyboard/system.rs` | 14 | 0 | 20d | 2026-07-15 | 1/1 (100%) | ✅ |
| 21% | `crates/engine_render/src/rect.rs` | 22 | 0 | 16d | 2026-07-19 | 0 mutants | ➖ |
| 21% | `crates/engine_scene/src/render_order.rs` | 29 | 0 | 14d | 2026-07-21 | 4/4 (100%) | ✅ |
| 21% | `crates/card_game/src/stash/toggle.rs` | 10 | 0 | 21d | 2026-07-14 | 2/2 (100%) | ✅ |
| 21% | `crates/engine_render/src/testing/helpers.rs` | 10 | 0 | 21d | 2026-07-14 | 0/1 (0%) | ⚠️ |
| 20% | `crates/engine_core/src/error.rs` | 8 | 0 | 22d | 2026-07-13 | 0 mutants | ➖ |
| 20% | `crates/engine_render/src/shape/cache.rs` | 16 | 0 | 17d | 2026-07-18 | 1/1 (100%) | ✅ |
| 20% | `crates/card_game/src/card/identity/name_pools/mod.rs` | 28 | 0 | 13d | 2026-07-22 | 0/1 (0%) | ⚠️ |
| 20% | `crates/card_game/src/card/component.rs` | 47 | 0 | 9d | 2026-07-26 | 0/1 (0%) | ⚠️ |
| 19% | `crates/engine_physics/src/physics_sync_system.rs` | 17 | 0 | 15d | 2026-07-20 | 1/1 (100%) | ✅ |
| 19% | `crates/engine_audio/src/prelude.rs` | 10 | 1 | 15d | 2026-07-20 | 0 mutants | ➖ |
| 19% | `crates/engine_audio/src/playback/buffer.rs` | 43 | 0 | 8d | 2026-07-27 | 0/2 (0%) | ⚠️ |
| 19% | `crates/card_game/src/card/interaction/physics_helpers.rs` | 35 | 0 | 9d | 2026-07-26 | 1/1 (100%) | ✅ |
| 19% | `crates/card_game/src/stash/boundary.rs` | 68 | 0 | 4d | 2026-07-31 | 12/12 (100%) | ✅ |
| 18% | `crates/engine_audio/src/audio_res.rs` | 21 | 0 | 11d | 2026-07-24 | 0/2 (0%) | ⚠️ |
| 18% | `crates/engine_physics/src/physics_command_apply_system.rs` | 65 | 0 | 3d | 2026-08-01 | 1/1 (100%) | ✅ |
| 18% | `crates/card_game/src/card/identity/residual.rs` | 77 | 0 | 1d | 2026-08-03 | 26/28 (93%) | ✅ |
| 17% | `crates/engine_core/src/scale_spring.rs` | 70 | 0 | 1d | 2026-08-03 | 14/19 (74%) | ⚠️ |
| 17% | `crates/engine_render/benches/stress.rs` | 73 | 0 | today | 2026-08-04 | 0 mutants | ➖ |
| 17% | `crates/card_game/src/card/reader/eject.rs` | 54 | 0 | 2d | 2026-08-02 | 1/2 (50%) | ✅ |
| 16% | `crates/card_game/src/card/interaction/drag_state.rs` | 24 | 0 | 7d | 2026-07-28 | 0 mutants | ➖ |
| 16% | `crates/engine_core/src/event_bus.rs` | 37 | 0 | 3d | 2026-08-01 | 6/14 (43%) | ✅ |
| 16% | `crates/engine_core/src/window.rs` | 19 | 1 | 4d | 2026-07-31 | 0 mutants | ➖ |
| 16% | `crates/engine_ui/src/layout/system.rs` | 30 | 0 | 4d | 2026-07-31 | 3/3 (100%) | ✅ |
| 16% | `crates/engine_physics/src/hit_test.rs` | 11 | 0 | 11d | 2026-07-24 | 8/8 (100%) | ✅ |
| 16% | `crates/engine_audio/src/playback/id.rs` | 2 | 0 | 23d | 2026-07-12 | 0 mutants | ➖ |
| 15% | `crates/card_game/src/stash/constants.rs` | 25 | 0 | 5d | 2026-07-30 | 4/4 (100%) | ✅ |
| 15% | `crates/card_game/benches/stress.rs` | 50 | 0 | today | 2026-08-04 | 0 mutants | ➖ |
| 15% | `crates/engine_scene/src/spawn_child.rs` | 10 | 0 | 11d | 2026-07-24 | 0/1 (0%) | ⚠️ |
| 15% | `crates/card_game/src/card/interaction/mod.rs` | 14 | 0 | 8d | 2026-07-27 | 0 mutants | ➖ |
| 15% | `crates/engine_ui/src/widget/node.rs` | 37 | 0 | 1d | 2026-08-03 | 3/3 (100%) | ✅ |
| 15% | `crates/engine_render/src/clear.rs` | 13 | 0 | 8d | 2026-07-27 | 1/1 (100%) | ✅ |
| 14% | `crates/engine_ui/src/lib.rs` | 15 | 1 | 3d | 2026-08-01 | 3/3 (100%) | ✅ |
| 14% | `crates/card_game/src/card/interaction/release.rs` | 2 | 0 | 20d | 2026-07-15 | 0 mutants | ➖ |
| 13% | `crates/engine_input/src/prelude.rs` | 7 | 0 | 10d | 2026-07-25 | 0 mutants | ➖ |
| 12% | `crates/engine_physics/src/physics_step_system.rs` | 20 | 0 | today | 2026-08-04 | 1/1 (100%) | ✅ |
| 10% | `crates/card_game/src/card/identity/signature.rs` | 4 | 0 | 9d | 2026-07-26 | 0 mutants | ➖ |
| 10% | `crates/engine_input/src/lib.rs` | 7 | 0 | 5d | 2026-07-30 | 0 mutants | ➖ |
| 10% | `crates/card_game/src/terrain/mod.rs` | 4 | 1 | 5d | 2026-07-30 | 0 mutants | ➖ |
| 9% | `crates/engine_audio/src/backend/mod.rs` | 4 | 0 | 6d | 2026-07-29 | 0 mutants | ➖ |
| 9% | `crates/engine_ecs/src/prelude.rs` | 7 | 0 | 2d | 2026-08-02 | 0 mutants | ➖ |
| 5% | `crates/axiom2d/src/lib.rs` | 3 | 0 | 2d | 2026-08-02 | 0 mutants | ➖ |
