...
**Cumulative (all runs)**: 1707 mutants | 290 caught | 1365 missed | 4 timeout | 48 unviable | 12 zero-mutant | 1 errors | **catch rate: 17.5%** | 46 runs | 47 files tested

**Last run**: 2026-07-25 (`10632da`)
...
| 77% | `crates/card_game/src/booster/device.rs` | 377 | 2 | 90d | never | — | ⬜ |
...
| 62% | `crates/card_game/src/card/interaction/drag_state.rs` | 24 | 0 | 90d | never | — | ⬜ |
...
| 53% | `crates/particle_poc/src/state.rs` | 2246 | 9 | 9d | 2026-07-16 | 0/1238 (0%) | ⚠️ |
| 53% | `crates/engine_assets/src/prelude.rs` | 2 | 0 | 90d | never | — | ⬜ |
| 53% | `crates/engine_ecs/src/lib.rs` | 2 | 0 | 90d | never | — | ⬜ |
| 35% | `crates/card_game/src/stash/store.rs` | 555 | 5 | today | 2026-07-25 | error | ❌ |
| 33% | `crates/card_game/src/card/screen_device.rs` | 389 | 4 | 2d | 2026-07-23 | 24/86 (28%) | ⚠️ |
| 31% | `crates/engine_render/src/testing/mod.rs` | 385 | 0 | 13d | 2026-07-12 | 28/59 (47%) | ⚠️ |
| 30% | `crates/axiom2d/src/splash/letters.rs` | 270 | 1 | 10d | 2026-07-15 | 0 mutants | ➖ |
| 28% | `crates/axiom2d/src/default_plugins.rs` | 203 | 1 | 9d | 2026-07-16 | 5/6 (83%) | ⚠️ |
| 27% | `crates/card_game/src/card/identity/card_name.rs` | 113 | 0 | 15d | 2026-07-10 | 0 mutants | ✅ |
| 26% | `crates/engine_core/src/time.rs` | 123 | 0 | 12d | 2026-07-13 | 13/20 (65%) | ✅ |
| 25% | `crates/engine_scene/src/transform_propagation.rs` | 74 | 0 | 15d | 2026-07-10 | 0 mutants | ✅ |
| 25% | `crates/card_game/src/card/rendering/debug_spawn.rs` | 79 | 0 | 14d | 2026-07-11 | 3/3 (100%) | ✅ |
| 24% | `crates/engine_render/src/shader.rs` | 66 | 0 | 14d | 2026-07-11 | 19/22 (86%) | ✅ |
| 24% | `crates/engine_render/src/atlas.rs` | 163 | 2 | today | 2026-07-25 | 57/60 (95%) | ✅ |
| 24% | `crates/card_game/src/card/reader/spawn.rs` | 229 | 0 | 4d | 2026-07-21 | 0/32 (0%) | ⚠️ |
| 24% | `crates/terrain/src/material.rs` | 130 | 0 | 8d | 2026-07-17 | 2/5 (40%) | ⚠️ |
| 23% | `crates/axiom2d/src/splash/mod.rs` | 15 | 3 | 12d | 2026-07-13 | 0 mutants | ➖ |
| 23% | `crates/card_game/src/plugin.rs` | 203 | 0 | 3d | 2026-07-22 | 2/2 (100%) | ✅ |
| 21% | `crates/card_game/src/hand/cards.rs` | 52 | 1 | 7d | 2026-07-18 | 13/16 (81%) | ⚠️ |
| 21% | `crates/engine_ui/src/draw_command.rs` | 84 | 0 | 7d | 2026-07-18 | 2/7 (29%) | ⚠️ |
| 21% | `crates/engine_render/src/bloom.rs` | 43 | 0 | 11d | 2026-07-14 | 22/22 (100%) | ✅ |
| 20% | `crates/card_game/src/card/identity/name_pools/templates.rs` | 87 | 0 | 5d | 2026-07-20 | 18/29 (62%) | ⚠️ |
| 20% | `crates/engine_core/src/scale_spring.rs` | 70 | 0 | 6d | 2026-07-19 | 14/19 (74%) | ⚠️ |
| 20% | `crates/engine_input/src/mouse_button.rs` | 22 | 0 | 14d | 2026-07-11 | 0/1 (0%) | ⚠️ |
| 20% | `crates/engine_core/benches/spring.rs` | 97 | 0 | 3d | 2026-07-22 | 0 mutants | ➖ |
| 19% | `crates/engine_physics/benches/stress.rs` | 45 | 0 | 8d | 2026-07-17 | 0 mutants | ➖ |
| 19% | `crates/card_game/src/card/reader/drag.rs` | 67 | 0 | 4d | 2026-07-21 | 5/9 (56%) | ⚠️ |
| 18% | `crates/engine_audio/src/mixer.rs` | 44 | 0 | 6d | 2026-07-19 | 6/6 (100%) | ✅ |
| 18% | `crates/card_game/src/card/identity/name_pools/syllables.rs` | 33 | 0 | 8d | 2026-07-17 | 2/2 (100%) | ✅ |
| 17% | `crates/card_game/src/card/reader.rs` | 22 | 0 | 9d | 2026-07-16 | 0 mutants | ➖ |
| 16% | `crates/card_game/src/card/art/mod.rs` | 49 | 0 | 2d | 2026-07-23 | 17/18 (94%) | ⚠️ |
| 16% | `crates/card_game/src/card/interaction/flip_animation.rs` | 47 | 0 | 2d | 2026-07-23 | 21/23 (91%) | ⚠️ |
| 16% | `crates/engine_input/src/keyboard/system.rs` | 14 | 0 | 10d | 2026-07-15 | 1/1 (100%) | ✅ |
| 16% | `crates/engine_render/src/rect.rs` | 22 | 0 | 6d | 2026-07-19 | 0 mutants | ➖ |
| 15% | `crates/engine_scene/src/render_order.rs` | 29 | 0 | 4d | 2026-07-21 | 4/4 (100%) | ✅ |
| 15% | `crates/card_game/src/stash/toggle.rs` | 10 | 0 | 11d | 2026-07-14 | 2/2 (100%) | ✅ |
| 15% | `crates/engine_render/src/testing/helpers.rs` | 10 | 0 | 11d | 2026-07-14 | 0/1 (0%) | ⚠️ |
| 15% | `crates/engine_core/src/error.rs` | 8 | 0 | 12d | 2026-07-13 | 0 mutants | ➖ |
| 15% | `crates/engine_render/src/shape/cache.rs` | 16 | 0 | 7d | 2026-07-18 | 1/1 (100%) | ✅ |
| 15% | `crates/card_game/src/card/identity/name_pools/mod.rs` | 28 | 0 | 3d | 2026-07-22 | 0/1 (0%) | ⚠️ |
| 14% | `crates/engine_physics/src/physics_sync_system.rs` | 17 | 0 | 5d | 2026-07-20 | 1/1 (100%) | ✅ |
| 14% | `crates/engine_audio/src/prelude.rs` | 10 | 1 | 5d | 2026-07-20 | 0 mutants | ➖ |
| 13% | `crates/card_game/src/card/identity/signature.rs` | 4 | 0 | 13d | 2026-07-12 | 0 mutants | ➖ |
| 13% | `crates/engine_audio/src/audio_res.rs` | 21 | 0 | 1d | 2026-07-24 | 0/2 (0%) | ⚠️ |
| 10% | `crates/engine_physics/src/hit_test.rs` | 11 | 0 | 1d | 2026-07-24 | 8/8 (100%) | ✅ |
| 10% | `crates/engine_audio/src/playback/id.rs` | 2 | 0 | 13d | 2026-07-12 | 0 mutants | ➖ |
| 10% | `crates/engine_scene/src/spawn_child.rs` | 10 | 0 | 1d | 2026-07-24 | 0/1 (0%) | ⚠️ |
| 8% | `crates/card_game/src/card/interaction/release.rs` | 2 | 0 | 10d | 2026-07-15 | 0 mutants | ➖ |
| 8% | `crates/engine_input/src/prelude.rs` | 7 | 0 | today | 2026-07-25 | 0 mutants | ➖ |
