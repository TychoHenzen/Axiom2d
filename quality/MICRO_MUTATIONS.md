...
**Cumulative (all runs)**: 130 mutants | 87 caught | 15 missed | 0 timeout | 28 unviable | 4 zero-mutant | 0 errors | **catch rate: 85.3%** | 13 runs | 14 files tested

**Last run**: 2026-07-14 (`7aa1b9a`)
...
| 89% | `crates/card_game/src/stash/store.rs` | 555 | 7 | 90d | never | — | ⬜ |
...
| 85% | `crates/card_game/src/card/screen_device.rs` | 389 | 6 | 90d | never | — | ⬜ |
| 82% | `crates/particle_poc/src/lib.rs` | 1186 | 2 | 90d | never | — | ⬜ |
| 81% | `crates/card_game/src/booster/device.rs` | 377 | 4 | 90d | never | — | ⬜ |
| 81% | `crates/engine_render/src/font.rs` | 352 | 4 | 90d | never | — | ⬜ |
| 80% | `crates/card_game/src/card/jack_socket.rs` | 303 | 4 | 90d | never | — | ⬜ |
| 80% | `crates/engine_render/src/testing/visual_regression.rs` | 815 | 2 | 90d | never | — | ⬜ |
| 80% | `crates/engine_ui/src/unified_render.rs` | 448 | 3 | 90d | never | — | ⬜ |
| 80% | `crates/card_game/src/booster/opening.rs` | 421 | 3 | 90d | never | — | ⬜ |
| 79% | `crates/card_game/src/card/interaction/apply.rs` | 314 | 3 | 90d | never | — | ⬜ |
| 77% | `crates/card_game/src/stash/pages.rs` | 232 | 3 | 90d | never | — | ⬜ |
| 77% | `crates/card_game/src/plugin.rs` | 203 | 3 | 90d | never | — | ⬜ |
| 77% | `crates/engine_app/src/app.rs` | 337 | 2 | 90d | never | — | ⬜ |
...
| 76% | `crates/engine_render/src/shape/tessellate.rs` | 275 | 2 | 90d | never | — | ⬜ |
| 76% | `crates/engine_render/src/atlas.rs` | 163 | 3 | 90d | never | — | ⬜ |
| 76% | `crates/card_game/src/card/combiner_device.rs` | 253 | 2 | 90d | never | — | ⬜ |
| 76% | `crates/engine_physics/src/lib.rs` | 245 | 2 | 90d | never | — | ⬜ |
| 75% | `crates/terrain/src/material.rs` | 130 | 3 | 90d | never | — | ⬜ |
| 75% | `crates/axiom2d/src/default_plugins.rs` | 203 | 2 | 90d | never | — | ⬜ |
...
| 73% | `crates/card_game/src/card/reader/spawn.rs` | 229 | 1 | 90d | never | — | ⬜ |
...
| 25% | `crates/engine_render/src/testing/mod.rs` | 385 | 0 | 2d | 2026-07-12 | 28/59 (47%) | ⚠️ |
| 23% | `crates/card_game/src/card/identity/card_name.rs` | 113 | 1 | 4d | 2026-07-10 | 0 mutants | ✅ |
| 21% | `crates/engine_core/src/time.rs` | 123 | 1 | 1d | 2026-07-13 | 13/20 (65%) | ✅ |
| 21% | `crates/engine_scene/src/transform_propagation.rs` | 74 | 1 | 4d | 2026-07-10 | 0 mutants | ✅ |
| 21% | `crates/card_game/src/card/rendering/debug_spawn.rs` | 79 | 1 | 3d | 2026-07-11 | 3/3 (100%) | ✅ |
| 20% | `crates/engine_render/src/shader.rs` | 66 | 1 | 3d | 2026-07-11 | 19/22 (86%) | ✅ |
| 17% | `crates/axiom2d/src/splash/mod.rs` | 15 | 3 | 1d | 2026-07-13 | 0 mutants | ➖ |
| 17% | `crates/engine_render/src/bloom.rs` | 43 | 1 | today | 2026-07-14 | 22/22 (100%) | ✅ |
| 16% | `crates/engine_input/src/mouse_button.rs` | 22 | 1 | 3d | 2026-07-11 | 0/1 (0%) | ⚠️ |
| 11% | `crates/card_game/src/stash/toggle.rs` | 10 | 1 | today | 2026-07-14 | 2/2 (100%) | ✅ |
| 11% | `crates/engine_core/src/error.rs` | 8 | 1 | 1d | 2026-07-13 | 0 mutants | ➖ |
| 9% | `crates/engine_render/src/testing/helpers.rs` | 10 | 0 | today | 2026-07-14 | 0/1 (0%) | ⚠️ |
| 9% | `crates/card_game/src/card/identity/signature.rs` | 4 | 1 | 2d | 2026-07-12 | 0 mutants | ➖ |
| 4% | `crates/engine_audio/src/playback/id.rs` | 2 | 0 | 2d | 2026-07-12 | 0 mutants | ➖ |
