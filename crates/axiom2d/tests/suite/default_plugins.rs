...
fn app_with_default_plugins() -> engine_app::prelude::App {
    let mut app = engine_app::prelude::App::new();
...
fn when_frame_advanced_with_fake_clock_then_delta_time_is_updated() {
    ...
    app.world_mut()
        .insert_resource(engine_core::prelude::ClockRes::new(Box::new(fake)));
